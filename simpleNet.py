...
train_data = RegressionDataset('trainCred.csv')
test_data = RegressionDataset('testCred.csv')
...
widths = [100]
depths = [9]
activations = [(nn.ReLU(), init_he, "ReLU")]
        ...
        for depth in depths:
            ...
            class NeuralNetwork(nn.Module):
                def __init__(self):
                    ...
                    self.input = nn.Sequential(nn.Linear(29, width), ac_fn)
            ...
            plt.savefig(f"./images/InitiaNet.png")
            plt.close()
